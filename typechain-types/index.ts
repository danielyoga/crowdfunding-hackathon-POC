...
export type { IIDRX } from "./contracts/interfaces/IIDRX";
export { IIDRX__factory } from "./factories/contracts/interfaces/IIDRX__factory";
export type { MockIDRX } from "./contracts/mocks/MockIDRX";
export { MockIDRX__factory } from "./factories/contracts/mocks/MockIDRX__factory";
export type { SimpleProject } from "./contracts/SimpleCampaign.sol/SimpleProject";
export { SimpleProject__factory } from "./factories/contracts/SimpleCampaign.sol/SimpleProject__factory";
