  ...
  return (
    <footer className="bg-card border-t border-border" suppressHydrationWarning>
      <div className="container mx-auto px-4 py-12" suppressHydrationWarning>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8" suppressHydrationWarning>
          ...
          <div className="col-span-1 md:col-span-2" suppressHydrationWarning>
            <div className="flex items-center space-x-2 mb-4" suppressHydrationWarning>
              ...
              <span className="text-xl font-bold text-primary">GRU</span>
            </div>
            <p className="text-muted-foreground mb-4 max-w-md">
              Gru's villainous venture to fund the most audacious hackathon projects. 
              Decentralized crowdfunding for the mischievously brilliant.
            </p>
          ...
          <div suppressHydrationWarning>
            ...
            <ul className="space-y-2">
              <li><a href="#campaigns" className="text-muted-foreground hover:text-foreground transition-colors">Campaigns</a></li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center" suppressHydrationWarning>
          <div className="text-muted-foreground text-sm" suppressHydrationWarning>
            © 2024 Gru's Evil Genius Fund. All rights reserved.
          </div>
